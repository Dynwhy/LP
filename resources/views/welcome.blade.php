...
<body class="leading-normal tracking-normal" style="font-family: 'Montserrat', sans-serif">
  ...
  <nav class="flex items-center justify-between flex-wrap bg-blue-200 p-7 px-20">
    ...
    <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto text-center">
      ...
      <div>
        ...
        <button
          class="text-white-500 font-medium rounded-md py-3 px-4 border-2 border-black focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
  ...
  <footer class="text-center font-medium bg-blue-200 py-5">
    © {{ now()->year }} LapMar | By
    <a href="https://www.instagram.com/dioxyn.15" class="text-blue-500" target="_blank">Dio</a>
  </footer>
